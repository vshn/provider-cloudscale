...
// +kubebuilder:rbac:groups=cloudscale.crossplane.io,resources=providerconfigs,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=cloudscale.crossplane.io,resources=providerconfigs/status;providerconfigs/finalizers,verbs=get;update;patch

// +kubebuilder:rbac:groups=cloudscale.crossplane.io,resources=providerconfigusages,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=cloudscale.crossplane.io,resources=providerconfigusages/status;providerconfigusages/finalizers,verbs=get;update;patch
